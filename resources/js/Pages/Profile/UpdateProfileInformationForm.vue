            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card mt-4 mb-4">
                        <div class="card-body">
                            <form class="detail-form" @submit.prevent="updateUserInfo()">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">First Name</label>
                                        <input type="text" class="form-control f-16" v-model="editform.f_name"  placeholder="First Name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">Last Name</label>
                                        <input type="text" class="form-control f-16"  v-model="editform.l_name" placeholder="Last Name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">User Name</label>
                                        <input type="text" class="form-control f-16" v-model="editform.user_name"  placeholder="User Name">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">Mobile Number</label>
                                        <input type="text" class="form-control f-16" v-model="editform.mobile_number"  placeholder="Mobile Number">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">Email</label>
                                        <input type="text" class="form-control f-16" disabled v-model="editform.email"  placeholder="user@roamyhome.com">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="f-18 mb-2 mt-3">Specialized In</label>
                                        <input type="text" class="form-control f-16" v-model="editform.specialized_in"  placeholder="Homes">
                                    </div>
                                    <div class="form-group">
                                        <label class="f-18 mb-2 mt-3">Bio (Optional)</label>
